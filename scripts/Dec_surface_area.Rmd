...
#load wax data
wax.data <- read.csv("data/TPC/Dec_TPC_surface_area_data.csv", header=TRUE)
...
summary(stnd.curve)$r.squared #r-squared = 0.996
...
smpls%>%
  select(fragment_ID, surface.area.cm2)%>%
    write_csv("data/TPC/Dec_TPC_surface.area.calc.csv")
```
