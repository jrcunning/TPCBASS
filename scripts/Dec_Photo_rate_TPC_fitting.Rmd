...
d_params
write.csv(d_params, file = "data/processed/TPC_Dec_Photo_params_ind_without22.csv")

d_params %>%
ggplot(aes(x=Temp.Cat, y=ETR, color=Spat.ID))+
  geom_point()+
  geom_line()+
  facet_wrap("species")
  theme_bw()
...
d_params_groups
write_csv(d_params_groups, path = "data/processed/TPC_Dec_Photo_params_grp.csv")
```
